            ...
            >
              <div class="content-wrap">
                ...
                >
                  ...
                  >
                    ...
                    <div class="product-details">
                      ...
                      <span class="product-quantity">({{ product.count }} {{
                          $t('piece')
                        }})</span>
                      <div class="product-remove">
                                                <span @click="showDeletePopup = i" style="cursor: pointer"><i
                ...
                >
                  ...
                  <span class="total-price">
                                    <span class="Price-amount"> {{
                                        cartTotalPrice
                                      }} {{ settings ? settings.currency_value : null }}</span>
                                  </span>
                </div>
                ...
                <div
                    ...
                    v-if="shopProducts.length"
                >
                  <router-link class="button button-viewcart" :to="{name: 'ShoppingCart'}"
                               @click.native="hideCart"
                               :style="{'border': settings ? '1px solid' + settings.main_color : '1px solid white'}">
                    <span>{{ $t('shopping_cart') }}</span>
                  </router-link>
                  <router-link class="button button-checkout"
                               :to="{name: 'Checkout',  params: { shopProducts: shopProducts }}"
                               @click.native="hideCart"
