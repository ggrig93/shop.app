<template>
    <div class="header-device-mobile">
        <div class="wapper">
            <div class="wapper-first-item">
                <div class="item mobile-logo">
                    <div class="logo">
                        <router-link :to="{name: 'Home'}">
                            <svg width="169" height="80" viewBox="0 0 169 80" :fill="settings ? settings.main_color : null"
                                ...
                                <path
                                    ...
                                    :fill="settings ? settings.main_color : null"/>
                                <path
                                ...
                                <path
                                    ...
                                    :fill="settings ? settings.main_color : null"/>
                                <path d="M101.229 43.8457V65.8102H104.637V43.8457H101.229Z" :fill="settings ? settings.main_color : null"/>
                                <path
